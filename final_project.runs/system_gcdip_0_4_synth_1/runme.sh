...
HD_PWD='D:/EOS_Project/final_project/final_project.runs/system_gcdip_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_gcdip_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_gcdip_0_4.tcl
