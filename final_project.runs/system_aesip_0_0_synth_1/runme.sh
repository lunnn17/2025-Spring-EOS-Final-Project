...
HD_PWD='D:/EOS_Project/final_project/final_project.runs/system_aesip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_aesip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_aesip_0_0.tcl
