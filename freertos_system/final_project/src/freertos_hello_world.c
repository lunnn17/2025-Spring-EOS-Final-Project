...
void vTask1(void *pvParameters)
{
	...
	for(;;)
	{
		...
		vTaskDelay(pdMS_TO_TICKS(rand()&0x1FF));
	}
}
...
int main(void)
{
	char *pcTextForTask1 = "Task 1 -------------------------------------\r\n";
	char *pcTextForTask2 = "Task 2 -------------------------------------\r\n";
	char *pcTextForTask3 = "Task 3 -------------------------------------\r\n";
	srand(567);
	xMutex = xSemaphoreCreateMutex();
	if(xMutex != NULL)
	{
		xTaskCreate(vTask1, (const char*)"Task 1", 1000, (void*)pcTextForTask1, 2, NULL);
		xTaskCreate(vTask2, (const char*)"Task 2", 1000, (void*)pcTextForTask2, 2, NULL);
		xTaskCreate(vTask3, (const char*)"Task 3", 1000, (void*)pcTextForTask3, 3, NULL);
